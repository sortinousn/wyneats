      ...
      <div id="about-members">
        <div class="member-pics">
          ...
          <span id="joe-about" class="member-about">
            <h4>Joe</h4>
            <p>"It's not a bug. it's a feature" - Unknown</p>
          </span>
          <div>
            <span class="github">
              <a href="https://github.com/sortinousn" target="_blank">
                <img
                  class="github-pic"
                  src={githubPic}
                  alt="github"
            ...
            <span class="linkdin">
              <a
                href="https://www.linkedin.com/in/josephsortino/"
                target="_blank"
              >
                <img
                  class="linkedin-pic"
        ...
        <div class="member-pics">
          ...
          <span id="jamile-about" class="member-about">
            <h4>Jamile</h4>
            <p>
              "For the benefit of the flower, we water the thorns too" -
              Egyptian Proverb
            </p>
          </span>
          <div>
            <span class="github">
              <a href="https://github.com/reidjamile" target="_blank">
                <img
                  class="github-pic"
                  src={githubPic}
                  alt="github"
            ...
            <span class="linkdin">
              <a
                href="https://www.linkedin.com/in/jamile-reid-1b075a99/"
                target="_blank"
              >
                <img
                  class="linkedin-pic"
        ...
        <div class="member-pics">
          ...
          <div>
            <span class="github">
              <a href="https://github.com/lavonnyka" target="_blank">
                <img
                  class="github-pic"
                  src={githubPic}
                  alt="github"
            ...
            <span class="linkdin">
              <a
                href="https://www.linkedin.com/in/lavonnyka-howell-20906316b"
                target="_blank"
              >
                <img
                  class="linkedin-pic"
        ...
        <div class="member-pics">
          ...
          <div>
            ...
            <span class="linkdin">
              <a
                href="http://www.linkedin.com/in/sonia-st-remy"
                target="_blank"
              >
                <img
                  class="linkedin-pic"
        ...
        <div class="member-pics">
          ...
          <div>
            <span class="github">
              <a href="https://github.com/dlovett712" target="_blank">
                <img
                  class="github-pic"
                  src={githubPic}
                  alt="github"
            ...
            <span class="linkdin">
              <a
                href="https://www.linkedin.com/in/dean-lovett/"
                target="_blank"
              >
                <img
                  class="linkedin-pic"
